...
3. **어휘 수준은 TOPIK TOPIK 2급~3급 사이로 제한하라.** 학생은 한국어를 배우는 이탈리아 초중급자이다.
   - ✅ 허용: 기본 동사(가다, 오다, 먹다, 사다, 주다), 기본 형용사(좋다, 크다, 작다), 일상 명사, '-아/어요', '-을/를', '-이에요/예요' 같은 단순 문형
   - ❌ 금지: 관용구, 사자성어, 신조어, 축약어, 피동/사동 표현, 복합 연결어미(-(으)ㄹ수록, -다 보면 등)
   - 문장은 최대 1~2개. 짧고 단순하게.
