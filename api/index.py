...
4-1. 시제 뉘앙스 차이 (-0.2 ~ -0.5점)
     - 현재형 ↔ 현재진행형 등 미세한 시제 차이
     - 예: "먹고 있다" → "Mangio" (Sto mangiando가 더 정확)
     - 예: "비가 온다" → "Pioverà" (미래형은 틀림)

4-2. 강도/정도 표현 누락 (-0.5 ~ -1.5점)
     - "많이", "조금", "매우" 등의 부사 누락
     - 예: "비가 많이 온다" → "Piove"
     - 예: "아주 예쁘다" → "È bella"
...
5-2. 직역으로 인한 어색함
     - 예: "비가 온다" → "La pioggia viene"
     - 의미는 정확하나 이탈리아어로 부자연스러운 표현
     - 판정: 10.0점 유지
     - [교사용 참고] "Piove가 더 자연스러운 표현입니다"

5-3. 관용구의 직역
     - 예: "표를 끊다" → "tagliare i biglietti"
     - 학생이 관용구를 이해했으나 직역한 경우
     - 판정: 10.0점 유지
     - [교사용 참고] "comprare i biglietti가 자연스러운 표현입니다"
...
• 예시:
  [교사용 참고] "학생의 번역은 정확하나, 'Si trova a casa'보다 
  'È a casa'가 더 자연스럽고 일상적인 표현입니다."
